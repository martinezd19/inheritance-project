...
public class AnimateCharacter {
    ...
    public AnimateCharacter(int currentXGrid, int currentYGrid, URL fileURL, String[] spriteOrder) throws MalformedURLException {
        ...
        for(int i = 0; i < Movements.values().length; i++) {
            ...
            Movements.valueOf(spriteOrder[i]).setSpriteImages(spriteImages);
        }

        spriteAnimator = new AnimateSprite();
